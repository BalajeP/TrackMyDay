...
export const SACRED_TITHI_TYPES: SacredTithiMeta[] = [
  ...
  },
  {
    ...
    nameHi: 'जन्मदिन',
    icon: '🎂',
    description: 'Birthday Celebration & Special Reminders',
    descriptionTa: 'பிறந்தநாள் கொண்டாட்டம் மற்றும் நினைவூட்டல்',
    descriptionHi: 'जन्मदिन उत्सव एवं विशेष स्मरण',
    dates: [],
  },
  {
    key: 'travel',
    ...
    nameHi: 'यात्रा',
    icon: '🚌',
    description: 'Travel, Trip & Outing Schedule',
    descriptionTa: 'பயணம் மற்றும் வெளியூர் பயணம்',
    descriptionHi: 'यात्रा एवं भ्रमण अनुसूची',
    dates: [],
  },
  {
    key: 'exam',
    ...
    nameHi: 'परीक्षा',
    icon: '📝',
    description: 'Exam & Test Schedule Reminders',
    descriptionTa: 'தேர்வு மற்றும் பாட நினைவூட்டல்',
    descriptionHi: 'परीक्षा एवं टेस्ट स्मरण पत्र',
    dates: [],
  },
  {
    key: 'temple',
    name: 'Temple Visit',
    nameTa: 'கோயில் வழிபாடு',
    nameHi: 'मंदिर दर्शन',
    icon: '🛕',
    description: 'Temple Visit & Special Worship',
    descriptionTa: 'கோயில் வழிபாடு மற்றும் சிறப்பு பூஜை',
    descriptionHi: 'मंदिर दर्शन एवं विशेष पूजा',
    dates: [],
  },
];
